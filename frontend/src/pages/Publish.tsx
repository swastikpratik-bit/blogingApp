...
export const Publish = () => {
    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-8"> 
            <div className="w-[90vw] lg:max-w-screen-lg lg:w-full">
                <input onChange={(e) => {
        ...
        <div className="w-full mb-4 ">
            <div className="flex items-center justify-between border">
                <div className="my-2 bg-white rounded-b-lg w-full">
                    <textarea onChange={onChange} id="editor" rows={8} className="h-[65vh] focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 pl-2" placeholder="Write an article..." required />
                </div>
            </div>
        </div>
    </div>)
