...
// .wrangler/tmp/bundle-WsIajl/checked-fetch.js
...
// .wrangler/tmp/bundle-WsIajl/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-WsIajl/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.get("/api/v1/blog/:id", (c) => {
  ...
  console.log(id);
  return c.json({ message: "get blog route" });
});
